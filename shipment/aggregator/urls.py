...
urlpatterns = [
    ...
    path('manual-rate/<company_id>/', ManualRateFilterWithCompanyIdAPIView.as_view(), name='manual-rate-version-with-company_Id'),
    path('manual-rate/<source_id>/<destination_id>/', ManualRateWithRateWithVersionsAPIView.as_view(), name='manual-rate-version'),

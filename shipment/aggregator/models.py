...
class VersionedRate(models.Model):
    ...
    terms_condition = models.CharField(max_length=50, blank=True, null=True)
...
class ManualRate(models.Model):
    ...
    # cargotype = models.ForeignKey(Comodity,null=True, on_delete=models.CASCADE)
    cargotype = models.CharField(max_length=15, null=True, default='General')  
    vessel_name = models.CharField(max_length=50, null=True, default='N/A')  
    voyage = models.CharField(max_length=50, null=True, default='N/A')  
    haz_class = models.CharField(max_length=50, null=True, default='N/A')  
    packing_group = models.CharField(max_length=50, null=True, default='N/A') 
    hazardous = models.BooleanField(default=False, null=True)
    un_number = models.CharField(max_length=4, null=True, default='') 
    direct_shipment = models.BooleanField(blank=True, null=True, default=False)
    spot_filed = models.CharField(max_length=15, default='spot')
    isRateTypeStatus = models.BooleanField(blank=True, null=True, default=False)
    isRateUsed = models.BooleanField(default=False)
    transhipment_add_port = models.CharField(blank=True, null=True, max_length=50, default='') 
    expiration_date = models.DateField(null=True, default=None) 
    remarks = models.TextField(blank=True, null=True, default='')
    terms_condition = models.CharField(max_length=50, blank=True, null=True, default='')  
    soft_delete = models.BooleanField(blank=True, null=True, default=False)
    version = models.ForeignKey(VersionedRate, on_delete=models.CASCADE, related_name='manualrates')

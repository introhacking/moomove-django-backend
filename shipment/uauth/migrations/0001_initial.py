# Generated by Django 5.0.6 on 2025-01-03 08:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role_name', models.CharField(choices=[('System Administrator', 'System Administrator'), ('Client Administrator', 'Client Administrator'), ('Client User (Edit and Read)', 'Client User (Edit and Read)'), ('Client User (Read Only)', 'Client User (Read Only)'), ('User', 'User')], max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('email', models.EmailField(default='placeholder@example.com', max_length=254, unique=True)),
                ...
                ('role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='uauth.roletype')),
            ],
            options={
                'abstract': False,
            },
